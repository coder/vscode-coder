export const lightTheme: Array<[string, string]> = [
	...
	["--vscode-agentSessionReadIndicator-foreground", "rgba(59, 59, 59, 0.2)"],
	...
	["--vscode-aiCustomizationManagement-sashBorder", "#e5e5e5"],
	...
	["--vscode-extensionButton-background", "#e5e5e5"],
	["--vscode-extensionButton-border", "rgba(0, 0, 0, 0.1)"],
	["--vscode-extensionButton-foreground", "#3b3b3b"],
	["--vscode-extensionButton-hoverBackground", "#cccccc"],
	...
	["--vscode-inlineEdit-gutterIndicator\.secondaryBackground", "#f8f8f8"],
